...
const allProducts = [
  ...
  { id: 5, name: 'Ajrak Print Pure Cotton Kurti', price: '₹1,199', image: '/kurti-ajrak-1.jpg', type: 'long', printType: 'ajrak' },
  { id: 6, name: 'Bagh Print 3 Piece Set', price: '₹1,799', image: '/set-bagh-1.jpg', type: '2-piece', printType: 'bagh' },
  { id: 7, name: 'Jaipur Hand Block Print Short Kurti', price: '₹999', image: '/kurti-jaipur-1.jpg', type: 'short', printType: 'handblock-jaipur' },
  { id: 8, name: 'Mul Hand Block Print Long Kurti', price: '₹1,399', image: '/kurti-mul-1.jpg', type: 'long', printType: 'handblock-mul' },
  { id: 9, name: 'Kalamkari Print 2 Piece Set with Dupatta', price: '₹1,699', image: '/set-kalamkari-2.jpg', type: '2-piece', printType: 'kalamkari' },
  { id: 10, name: 'Pure Cotton Hand Block Print Kurti', price: '₹1,099', image: '/kurti-cotton-1.jpg', type: 'short', printType: 'handblock' },
  { id: 11, name: 'Mangalgiri Woven Kurti', price: '₹1,499', image: '/kurti-mangalgiri-1.jpg', type: 'long', printType: 'mangalgiri' },
  { id: 12, name: 'Ikat Premium Long Kurti', price: '₹1,899', image: '/kurti-ikat-1.jpg', type: 'long', printType: 'ikat-premium' },
  { id: 13, name: 'Cotton Prints Short Kurti', price: '₹799', image: '/kurti-prints-1.jpg', type: 'short', printType: 'cotton-prints' },
  { id: 14, name: 'Cotton Silk Long Kurti', price: '₹1,999', image: '/kurti-silk-1.jpg', type: 'long', printType: 'cotton-silk' },
  { id: 15, name: 'Chanderi Silk Kurti', price: '₹2,199', image: '/kurti-chanderi-1.jpg', type: 'long', printType: 'chanderi-silk' },
  { id: 16, name: 'Ikat Plain Long Kurti', price: '₹1,299', image: '/kurti-plain-1.jpg', type: 'long', printType: 'ikat-plain' },
];
